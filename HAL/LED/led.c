...
// 	dio_vidConfigChannel(LED_NEW_PORT,LED_NEW_CHANNEL,OUTPUT);
// 	dio_vidConfigChannel(LED_NEW1_PORT,LED_NEW1_CHANNEL,OUTPUT);
}
...
// 		case LED_NEW:
// 		#if (LED_NEW_CONNECTION == SOURCE)
// 		dio_vidWriteChannel(LED_NEW_PORT,LED_NEW_CHANNEL,STD_HIGH);
// 		#elif (LED_RED_CONNECTION == SINK)
// 		dio_vidWriteChannel(LED_NEW_PORT,LED_NEW_CHANNEL,STD_LOW);
// 		#endif
// 		break;
// 		
// 		case LED_NEW1:
// 		#if (LED_NEW1_CONNECTION == SOURCE)
// 		dio_vidWriteChannel(LED_NEW1_PORT,LED_NEW1_CHANNEL,STD_HIGH);
// 		#elif (LED_RED_CONNECTION == SINK)
// 		dio_vidWriteChannel(LED_NEW1_PORT,LED_NEW1_CHANNEL,STD_LOW);
// 		#endif
// 		break;
...
// 		case LED_NEW:
// 		dio_vidFlipChannel(LED_NEW_PORT,LED_NEW_CHANNEL);
// 		break;
// 		
// 		case LED_NEW1:
// 		dio_vidFlipChannel(LED_NEW1_PORT,LED_NEW1_CHANNEL);
// 		break;
